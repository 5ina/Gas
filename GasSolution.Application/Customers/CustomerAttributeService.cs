...
{
    public class CustomerAttributeService : GasSolutionAppServiceBase, ICustomerAttributeService
    {
        ...
        /// 用户属性{0} 用户主键
        /// </summary>
        private const string CUSTOMER_ATTRIBUTES_BY_ID = "gas.cache.customer.attributes.byId{0}";
