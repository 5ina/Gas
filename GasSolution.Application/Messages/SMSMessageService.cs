...
{
    public class SMSMessageService : GasSolutionAppServiceBase, ISMSMessageService
    {

        #region Ctor && Field
        private const string SMSMESSAGENAME = "gas.cache.settings.sms";
        ...
        public SMSMessageService(ISettingService settingService)
        {
            ...
            this.accessKeyId = settingService.GetSettingByKey<string>(AliyunSettingNames.AccessKeyId);
            this.accessKeySecret = settingService.GetSettingByKey<string>(AliyunSettingNames.AccessKeySecret);            
