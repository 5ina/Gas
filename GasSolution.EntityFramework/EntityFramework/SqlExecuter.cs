...
namespace GasSolution.EntityFramework
{
    ...
    {
        private readonly IDbContextProvider<GasSolutionDbContext> _dbContextProvider;

        public SqlExecuter(IDbContextProvider<GasSolutionDbContext> dbContextProvider)
        {
